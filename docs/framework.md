...
- 采用OGNL作为默认表达式引擎
- 引入JavaScript、Groovy、TinyScript、Funic、Java作为脚本引擎
...
| lang-eval-funic    | Funic执行      | LangEvalFunicNode      |
...
| test   | 条件布尔表达式 | OGNL                                    |
| eval   | 脚本表达式执行 | TinyScript/Funic/JavaScript/Groovy/Java |
...
### 9.3 DefaultFunicResolver 解析器实现

根据 [DefaultFunicResolver.java](/src/main/java/.../extension/antlr4/script/funic/lang/resolver/impl/DefaultFunicResolver.java)：
...
2. **多引擎支持**：集成TinyScript、Funic、OGNL、Velocity等多种表达式引擎
3. **多语言支持**：支持Java、JavaScript、Groovy、TinyScript、Funic脚本
